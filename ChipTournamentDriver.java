...
{
  public static ChipsPlayer[] lineup = {new DivisionPlayer(), new OneThirdPlayer(), new OneFourth(), new OneFifthPlayer(), new OnebyOnePlayer(), new NimPlayer(), new LogarithmicPlayer(), new HardCodePlayer(), new FibonacciPlayer()}; // declares and initializes an array of players
